...
const PrayerJournal = () => {
  ...
  return (
    <div className="min-h-screen flex bg-sacred-gradient">
      {/* Sidebar */}
      <div className="bg-white/95 backdrop-blur-sm border-r border-sacred-sage-border/20 flex flex-col items-center py-5 fixed h-full left-0 top-0 z-50 shadow-xl" style={{ width: '70px' }}>
        {/* Logo */}
        <div 
      ...
      {/* Main Content */}
      <div className="flex-1 pl-8" style={{ marginLeft: '70px' }}>
        {/* Search Bar */}
